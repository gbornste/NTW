...
export default function TodaysHeadlinesPage() {
  ...
  return (
    <div className="container py-10 px-4 md:px-6">
      <div className="flex flex-col items-center text-center mb-10">
        <h1 className="text-3xl font-bold mb-2">TODAY'S HEADLINES</h1>
        ...
        <p className="text-muted-foreground max-w-[700px] mb-4">
          The latest news headlines from today, updated in real-time
        </p>
      ...
      <Tabs defaultValue="headlines" value={activeTab} onValueChange={setActiveTab} className="max-w-4xl mx-auto">
        <TabsList className="mb-4 grid w-full grid-cols-2">
          <TabsTrigger value="headlines">Today's Headlines</TabsTrigger>
          <TabsTrigger value="trump">Today's Trump News</TabsTrigger>
        </TabsList>
              ...
              <CardContent className="pt-6">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-sm mt-2">
                    We couldn't find any {activeTab === "trump" ? "Trump-related " : ""}news articles from today.
                  </p>
                  <Button variant="outline" size="sm" onClick={() => fetchNews()} className="mt-2">
