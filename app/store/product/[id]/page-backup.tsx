          ...
          <div className="grid grid-cols-4 gap-3">
            {product.images.slice(0, 8).map((image, index) => (
              <button
                ...
                className={\spect-square bg-gray-100 rounded-xl overflow-hidden border-3 transition-all duration-200 \\}
              >
                <img
                  src={image.src}
                  alt={\\ view \\}
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl">
            <div className="flex items-center gap-4 mb-2">
              ...
              <span className="text-2xl text-gray-500 line-through">\</span>
              <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-semibold">SAVE 25%</span>
            </div>
            <p className="text-gray-600">Free shipping on orders over \  30-day returns</p>
          </div>
              ...
              <div className="flex flex-wrap gap-3">
                {colors.map((color) => (
                  <button
                    ...
                    className={\elative w-12 h-12 rounded-full border-3 transition-all duration-200 \\}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-600">
                Total: <span className="font-semibold text-2xl">\</span>
              </span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button
                ...
                className={\lex-1 h-12 rounded-xl \\}
              >
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-green-600">Orders over \</span>
              </div>
              <div className="flex justify-between items-center">
