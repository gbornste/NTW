...
export default function BirthdayCardPage() {
  ...
  useEffect(() => {
    ...
    if (savedCard && savedCard.cardType === "birthday") {
  ...
  const predefinedMessages = [
    "Happy Birthday! Unlike Trump, you actually get better with age!",
    "Another year older and wiser - something Trump never managed!",
    "Happy Birthday! Your achievements are real, not inherited from daddy!",
    "Celebrating you today - someone who doesn't need to lie about their age!",
    "Happy Birthday to someone who's earned every celebration - no fake news here!",
  ]
  ...
  const cardData = {
    templateName: "Birthday Card",
    templateImage: "/images/trump-underwear.png", // Using graduation image for birthday
    message: getMessage(),
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-6">
        ...
        <h1 className="text-2xl font-bold">Birthday Card Creator</h1>
      </div>
      ...
      {currentView === "edit" ? (
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Create a personalized Birthday card with an anti-Trump twist</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              {selectedMessage === "custom" && (
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="custom-message"
                    placeholder="Write your own Birthday message here..."
                    value={customMessage}
                ...
                <div className="relative w-full max-w-md aspect-[3/4] bg-white rounded-lg shadow-lg overflow-hidden border">
                  <div className="absolute inset-0 flex flex-col">
                    <div className="bg-purple-600 text-white p-4 text-center">
                      <h3 className="text-xl font-bold">Happy Birthday</h3>
                    </div>
                    <div className="flex-1 p-6 flex flex-col items-center">
                      <div className="relative w-full h-48 mb-4">
                        <Image
                          src="/images/trump-underwear.png"
                          alt="Trump Birthday"
                          fill
        ...
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle>Your Birthday Card</CardTitle>
